      ...
      <div className="navbar-actions">
        {!address ? (
          <motion.button 
            ...
            onClick={onConnect}
            whileHover={{ scale: 1.04, transition: { duration: 0.3, ease: appleEase }, boxShadow: 'inset 0 0 20px rgba(244,63,94,0.5), 0 0 20px rgba(244,63,94,0.5), inset 0 1px 1px rgba(255,255,255,0.6)' }}
            whileTap={{ scale: 0.98 }}
            style={{ borderRadius: '999px', background: 'rgba(244,63,94,0.15)' }}
          >
            <Wallet size={16} />
            Connect Wallet
          </motion.button>
